...
class App(tk.Tk):
    ...
    def _build_view_publicar_linking(self):
        ...
        self._pl_log_write(
            "Publica TODOS los smart links (no solo los propios) de TODOS "
            "los archivos dentro de 'Estados Financieros/{año}/{período}' "
            "para el período que indiques. No crea ni copia nada — el "
            "período debe existir de antemano.", "muted")
    ...
    def _pl_on_run(self):
        ...
        confirmado = messagebox.askyesno(
            ...
            f"Esto va a PUBLICAR todos los smart links de todos los "
